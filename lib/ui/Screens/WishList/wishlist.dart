                                                                      ...
                                                                      RichText(
                                                                        text:
                                                                          ...
                                                                          children: <
                                                                            ...
                                                                            TextSpan(
                                                                                text: '  ${productUnit}',
                                                                                style: TextStyle(fontSize: 2.4 * SizeConfig.textMultiplier, color: Colors.blue)),
                                                                          ],
                                                                        ),
                                                                      ),
                                                                    ],
                                                            ...
                                                            InkWell(
                                                              ...
                                                              onTap: () {
                                                                setState(() {
                                                                  subCartNotifier
                                                                      .saveCart(
                                                                          productName,productPrice,productAssets,productstatus,productUnit);
                                                                  wishListNotifier
                                                                      .deleteWishList(
                                                                          wishId);
//                                                      wishlistItemList.removeAt(index);
